...
from .views import GraphData,ParallelCoordinates,verify,verifiedtoken,elevenlabs_text_to_speech,test_redis
...
urlpatterns = [
    ...
    #  path('powerbal/',PowerballSimulator_dj.as_view(),name='Powerball'),
      ...
      path('text_to_speech/',elevenlabs_text_to_speech,name='elevenlabs_text_to_speech'),
